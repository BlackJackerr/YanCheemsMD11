...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    ...
    return await XeonBotInc.relayMessage(chatId, generate.message, { messageId: generate.key.id })
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":botname, "h": wm,'seconds': '359996400', 'caption': `${pushname}`, 'jpegThumbnail': thumb}}}
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: wm,jpegThumbnail: thumb}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': ownername, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername}\nitem1.TEL;waid=6283890667327:6283890667327\nitem1.X-ABLabel:Mobile\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
break
            ...
            ryangk = await getBuffer(`https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`)
...
fs.writeFile(`${text}.jpg`, you, (err) => {
  if (err) {
   ...
   XeonBotInc.sendMessage(m.chat, { image: img, caption: cap }, { quoted: m });
...
case 'rate': {
            	...
            	if (text.toLowerCase().includes("yan") && text.toLowerCase().includes("mika") && !text.toLowerCase().includes("gak") && !text.toLowerCase().includes("gk")) return await replygcxeon(`*Rate ${text}*\nJawaban : 100%`)
...
replygcxeon("Success Sending Otp\n\nPlease Wait 30 Seconds To Send Again...")
}
break
case 'amountbug': {
if (!isPremium) return replygcxeon(mess.premium)
...
"sellerJid": "6283890667327@s.whatsapp.net",
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("6283890667327@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
